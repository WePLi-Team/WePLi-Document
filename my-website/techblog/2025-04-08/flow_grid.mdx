...
<div align="center">
  ...
  <p style={{ fontSize: "0.85rem", color: "#6c757d", textAlign: "center" }}>
    <a
      href="https://developer.android.com/develop/ui/compose/layouts/adaptive/support-different-screen-sizes?hl=ko&utm_source=chatgpt.com#explicit-layout-changes"
      target="_blank"
      rel="noopener noreferrer">
      다양한 크기 지원 | Jetpack Compose | Android Developers
    </a>
  </p>
</div>
