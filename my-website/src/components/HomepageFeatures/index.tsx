        ...
        <section className={`padding-vert--xl container ${styles.heroSection}`}>
          ...
          <div className="row">
            {[
              ...
              { title: '모니터링', link: '/docs/intro', description: '안드로이드 앱의 안정성을 확보하기 위해 Firebase Crashlytics를 사용하여 크래시 및 버그를 모니터링합니다. Google Play Console을 통한 사용자 리뷰 모니터링으로 신속한 피드백 수집 및 대응을 하고 있습니다.' },
              { title: '설계', link: '/docs/intro', description: 'Compose 및 MVI 아키텍처를 적용하여 UI와 비즈니스 로직을 효과적으로 분리하고 있습니다. 또한, Version Catalog와 Multi Module 구조를 도입하여 서비스의 모듈화와 확장성을 강화하고 있습니다.' },
